...
menu:
  leftnav:
    identifier: b3c4788985afe9fd0f8911d5af1fe098
    name: Syllabus
    weight: 10
title: Syllabus
type: course
uid: b3c4788985afe9fd0f8911d5af1fe098
...
Class assignments and final projects will be constructed using the python framework [_Kivy_](http://kivy.org). You will also need a few freely available software packages. See [the Tools section]({{< baseurl >}}/sections/tools) for the software requirements.
